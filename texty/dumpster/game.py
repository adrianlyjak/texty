...
def resume_game(io: IOInterface, game: GameRow):
    ...
    game_repl = TraditionalTextAdventureREPL(game.id, state, io)
    game_loop(game_repl)
...
def new_game(io: IOInterface):
    ...
    game_repl = TraditionalTextAdventureREPL(game_id, state, io)
...
def game_loop(game_repl: "TraditionalTextAdventureREPL"):
...
class TraditionalTextAdventureREPL:
    """
